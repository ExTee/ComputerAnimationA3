...
public class Contact {
    ...
    public Contact( RigidBody body1, RigidBody body2, Point2d contactW, Vector2d normal ) {
        ...
        GMatrix J = new GMatrix(2,6);
        
        //PA and PB are vectors from com to contactW
        Vector2d PA = new Vector2d(contactW.x - body1.x0.x , contactW.y - body1.x0.y);
        Vector2d PB = new Vector2d(contactW.x - body2.x0.x , contactW.y - body2.x0.y);
        ...
        //Signs??
        double[] row0 = new double[]{normal.x , normal.y, PA.x * normal.y - PA.y * normal.x, -normal.x, -normal.y, -(PB.x * normal.y - PB.y * normal.x)};
        double[] row1 = new double[]{tangent.x , tangent.y, PA.x * tangent.y - PA.y * tangent.x, -tangent.x, -tangent.y, -(PB.x * tangent.y - PB.y * tangent.x)};
